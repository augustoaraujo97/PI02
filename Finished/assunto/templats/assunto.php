...
<html lang="pt-br">
	<head>
		...
		<title>SENAQUIZ - PAINEL ASSUNTO</title>
	</head>
							...
							if($num > 0) {
								...
								echo "
									<tr>
										...
										<td class='cmdescricao1' style='background-color: $cor;'>".$valor['assdescricao']."</td>
										<td class='cmdescricao2' style='background-color: $cor;'>".$valor['ardescricao']."</td>
										<td class='cmdescricao2' style='background-color: $cor;'><a href='../questao/?pesq={$valor['assdescricao']}'>".$valor['qtd']."</a></td>
