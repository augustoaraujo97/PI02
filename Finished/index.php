...
<html lang="pt-br">
	...
	echo '
		...
		<div id="section">
			<div id="textos">
				<div id="txt1" class="visivel">Bem vindo! Aqui você poder&aacute; realizar altera&ccedil;&otilde;es de dados referente ao SENAQUIZ. Selecione um item abaixo para realizar altera&ccedil;&otilde;es.</div>

				<div id="txt2" class="invisivel">	Para realizar altera&ccedil;&otilde;es referente as &aacute;reas, <a href="area/index.php">clique aqui.</a> </div>
