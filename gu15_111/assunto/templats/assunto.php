				...
				<table>
					<thead>
						<tr>
							...
							<td class="cmdescricao"><strong>Quantidade de questões [Clique]</strong></td>
							...
							if($num > 0) {
								...
								echo "
									<tr>
										...
										<td class='cmdescricao'>".$valor['assdescricao']."</td>
										<td class='cmdescricao'>".$valor['ardescricao']."</td>
										<td class='cmdescricao'><a href='../questao/?pesq={$valor['qtd']}'>".$valor['qtd']."</a></td>
